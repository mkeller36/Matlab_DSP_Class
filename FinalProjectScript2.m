...
W = 85;
[dimefilter,xc,yc] = MakeCircleMatchingFilter(dimediameter,W);
[quarterfilter,xc,yc] = MakeCircleMatchingFilter(quarterdiameter,W);
[nickelfilter,xc,yc] = MakeCircleMatchingFilter(nickeldiameter,W);
